...
import com.pg.xi.tom.edi.dmtv01.*;
import com.sap.aii.mappingtool.functionlibrary.*;

public class FL_IA_EvaluateSAPISv38 extends AFunctionLibrary {
    ...
    @FunctionLibraryMethod(category = "FL_IA_EvaluateSAPISv38", title = "UDF_FromFLviaIA", executionType = "SINGLE_VALUE", key = "254a122b-2692-11f1-824e-020100d5c96a")
    public String UDF_FromFLviaIA(@UDFParam(paramCategory = "Argument", title = "") String cParameter, Container container) throws StreamTransformationException {
        final String cDebug = cCodex + "[UDF_FromFLviaIA]";
        String cReturn = "";
